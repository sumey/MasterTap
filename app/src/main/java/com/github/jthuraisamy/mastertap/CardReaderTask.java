...
public class CardReaderTask extends AsyncTask<Tag, Integer, String> {
	...
	private void readMasterCard(byte[] paymentDirectory, byte[] aidFci) {
		try {
			...
			//    0 123456789 10 11 12 13 14 15 16 HOLDER NAME 26 Char Max ExpiryDate ServiceCode  PVKI(1) PVV or OFFSET(4) CVV or CVC(3)
			String pan = new String(Arrays.copyOfRange(track1Data, 1, 16));
			// TODO Filed Separator ^ /^ 5E 20 2F 5E
			String expiryDate = new String(Arrays.copyOfRange(track1Data, 21/*45*/, 25/*49*/));
